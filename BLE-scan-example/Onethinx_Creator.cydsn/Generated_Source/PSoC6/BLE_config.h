...
#define CY_BLE_CONFIG_GAP_CENTRAL_COUNT             (0x01u)
 ...
 */ 
#define CY_BLE_CONFIG_GAP_ROLE                      (0x03u)
 ...
 * by this device.
 */
#define CY_BLE_CONFIG_MAX_RESOLVABLE_DEVICES        (8u)
 ...
 */
#define CY_BLE_CONFIG_GATT_MTU                      (0x00F8u)
 ...
 */
#define CY_BLE_DATA_INOUT_SERVICE_INDEX   (0x00u) /* Index of Data InOut service in the cy_ble_customs array */
#define CY_BLE_DATA_INOUT_DATA_OUT_CHAR_INDEX   (0x00u) /* Index of Data Out characteristic */
#define CY_BLE_DATA_INOUT_DATA_OUT_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
