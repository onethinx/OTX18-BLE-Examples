...
* for the Onethinx Core module by Onethinx Creator PostBuild 2.20
*
********************************************************************************
...
static void ClockInit(void)
{
	...
	Cy_SysClk_PeriphAssignDivider(PCLK_SCB2_CLOCK, CY_SYSCLK_DIV_16_5_BIT, 0u);
	Cy_SysClk_PeriphSetFracDivider(CY_SYSCLK_DIV_16_5_BIT, 0u, 4u, 11u);
